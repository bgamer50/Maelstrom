...
namespace maelstrom {
    ...
    namespace sparse {
        ...
        extern maelstrom::vector search_sorted_sparse_host_dispatch_ix(maelstrom::vector& row, maelstrom::vector& col, maelstrom::vector& ix_r, maelstrom::vector& ix_c, std::any index_not_found);
        
        template <typename E>
        extern maelstrom::vector search_sorted_sparse_device_dispatch_ix(E exec_policy, maelstrom::vector& row, maelstrom::vector& col, maelstrom::vector& ix_r, maelstrom::vector& ix_c, std::any index_not_found);

        maelstrom::vector search_sorted_sparse_dispatch_exec_policy(maelstrom::vector& row, maelstrom::vector& col, maelstrom::vector& ix_r, maelstrom::vector& ix_c, std::any index_not_found) {
        ...
        maelstrom::vector search_sorted_sparse(maelstrom::vector& row, maelstrom::vector& col, maelstrom::vector& ix_r, maelstrom::vector& ix_c, std::any index_not_found) {
