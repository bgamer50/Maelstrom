...
namespace maelstrom {
    ...
    void t_increment(E exec_policy, maelstrom::vector& vec, boost::any inc, size_t start, size_t end, maelstrom::inc_op op) {
        T inc_val;
    ...
    template<typename E>
    void increment_dispatch_val(E exec_policy, maelstrom::vector& vec, boost::any inc, size_t start, size_t end, maelstrom::inc_op op) {
    ...
    void increment_dispatch_exec_policy(maelstrom::vector& vec, boost::any inc, size_t start, size_t end, maelstrom::inc_op op) {
    ...
    void increment(maelstrom::vector& vec, boost::any inc, size_t start, size_t end, maelstrom::inc_op op) {
